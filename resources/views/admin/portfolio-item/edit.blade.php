            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.portfolio-item.update', $portfolioItem) }}" method="POST"
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <input type="text" value="{{ $portfolioItem->title }}" value="" name="title" value=""
                                            class="form-control">
                                    </div>
                                </div>
                                <div class="form-group row mb-4">
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <input type="text" value="{{ $portfolioItem->client }}" name="client" value=""
                                            class="form-control">
                                    </div>
                                </div>
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <input type="text" value="{{ $portfolioItem->website }}" name="website" value=""
                                            class="form-control">
                                    </div>
                                </div>
                                <div class="form-group row mb-4">
