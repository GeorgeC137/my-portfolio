        ...
        <div class="row">
            <div class="col-lg-6 offset-lg-3 text-center">
                <div class="section-title">
                    ...
                    <div class="desc">
                        <p>{{ strip_tags($blogTitle->sub_title) }}</p>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    @foreach($blogs as $blog)
                        <div class="single-blog">
                            ...
                            <div class="blog-content">
                                <h3 class="title"><a href="{{ route('show.blog', $blog) }}">{{ $blog->title }}</a>
                                </h3>
                                <div class="desc">
                                    <p>{{ Str::limit(strip_tags($blog->description), 150) }}</p>
                                </div>
                                <a href="{{ route('show.blog', $blog) }}" class="button-primary-trans mouse-dir">Read More <span
